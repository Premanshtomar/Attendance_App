...
class AppColors {
  static Color primaryAccentColor = const Color(0xFF6C63FF);
...
class NaturalColors {
  ...
  static Color blue = Colors.blueGrey;
  static Color lightBlueGrey = Colors.blueGrey.shade200;
  static Color darkBlueGrey = Colors.blueGrey.shade700;
